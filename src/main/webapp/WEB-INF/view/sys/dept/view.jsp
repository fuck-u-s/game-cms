...
<form class="layui-form" id="form" action="${path}/dept/update" method="post">
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">部门名称</label>
            <div class="layui-input-inline">
                <input type="hidden" name="id" value="${dept.id}" autocomplete="off" class="layui-input"/>
                <input type="text" name="name" lay-verify="name" value="${dept.name}" autocomplete="off" class="layui-input"/>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
...
<script src="${path}/static/js/sys/dept/setDept.js?v=444"></script>
