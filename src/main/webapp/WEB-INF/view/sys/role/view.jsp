...
<form class="layui-form" id="form" action="${path}/role/update" method="post">
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">角色名称</label>
            <div class="layui-input-inline">
                <input type="hidden" id="id" name="id" value="${role.id}"/>
                <input type="text" name="name" value="${role.name}" lay-verify="name" autocomplete="off" class="layui-input"/>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" id="status" name="status" value="${role.status}" <c:if test="${role.status==1}">checked="checked"</c:if>
                   lay-skin="switch" lay-filter="switchBox" lay-text="ON|OFF"/>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
