...
<form class="layui-form" id="form" action="${path}/video/updateVideo" method="post">
    ...
    <div class="layui-form-item" style="padding-top: 5px;">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 400px">
                <input type="text" name="title" value="${info.title}" lay-verify="required" maxlength="30" class="layui-input" placeholder="视频标题"/>
            </div>
        </div>
    </div>
            ...
            <div class="layui-input-inline" style="width: 400px">
                <select name="cate">
                    <c:forEach items="${cateList}" var="obj">
                        <option value="${obj.id}" <c:if test="${obj.id == info.cate}">selected="selected"</c:if>>${obj.name}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
            ...
            <div class="layui-input-inline" style="width: 400px">
                <select name="issuer">
                    <c:forEach items="${issList}" var="obj">
                        <option value="${obj.id}" <c:if test="${obj.id == info.issuer}">selected="selected"</c:if>>${obj.name}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="hidden" id="cover" name="cover" value="${info.cover}" lay-verify="cover"/>
                <button type="button" class="layui-btn" id="imageFile">头像</button>
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="${info.cover}" id="cover_image" style="width: 400px; height: 200px;"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <input type="hidden" id="url" name="url" value="${info.url}" lay-verify="url"/>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 400px">
                <input type="text" name="hot" lay-verify="required|number" value="${info.hot}" class="layui-input" placeholder="视频人气"/>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 400px">
                <input type="text" id="vtime" name="vtime" lay-verify="required" value="${info.vtime}" class="layui-input" placeholder="视频时长"/>
            </div>
        </div>
    </div>
...
<script src="${path}/static/js/video/video/set.js?v=132"></script>
