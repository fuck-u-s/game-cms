...
<form class="layui-form" id="form" action="${path}/video/saveVideo" method="post">

    <div class="layui-form-item" style="padding-top: 5px;">
        <div class="layui-inline">
            <label class="layui-form-label">标题</label>
            <div class="layui-input-inline" style="width: 400px">
                <input type="text" name="title" lay-verify="required" maxlength="30" class="layui-input" placeholder="视频标题"/>
            </div>
        </div>
    </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="/static/Hui/img/a5.jpg" id="cover_image" style="width: 400px; height: 200px;"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 400px">
                <input type="text" id="vtime" name="vtime" lay-verify="required" value="00:00" class="layui-input" placeholder="视频时长"/>
            </div>
        </div>
    </div>
...
<script src="${path}/static/js/video/video/set.js?v=19712111"></script>
