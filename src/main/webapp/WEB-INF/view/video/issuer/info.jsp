...
<form class="layui-form" id="form" action="${path}/video/issuer/updateIssuer" method="post">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 400px">
                <input type="text" name="name" value="${info.name}" lay-verify="required" maxlength="100" class="layui-input" placeholder="名称"/>
            </div>
        </div>
    </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <div class="layui-upload-list">
                    <img class="layui-upload-img" src="${info.cover}" id="cover_file" style="width: 200px; height: 200px;"/>
                </div>
            </div>
        </div>
    </div>
